...
class AdminBrandsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($validator->fails()) {
            ...
            return redirect()->route('brands.index')->with('information','Nowa marka została dodana do bazy danych.');
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('brands.index')->with('information','Zmieniono nazwy marek.');
    }
